...
/**
 * Diretório dos arquivos templates
 */
define ('TEMPLATE', VISAO . DS . "template1");
...
Controlador::configurarAmbiente();
...
define('BASE_DINAMICA', BASE .
    ((Controlador::$ambiente != Controlador::AMBIENTE_DEFAULT) ?
    ("/" . Controlador::$ambiente) : "")
);


// Despachando a requisição para o controlador
Controlador::invocarModulo();
